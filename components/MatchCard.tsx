  ...
  return (
    ...
    >
      ...
      <a 
        ...
        text-[#0d121d] shadow-[0_0_20px_rgba(0,212,255,0.6)]
          ...
          {!showPayment ? (
            <div className="grid grid-cols-2 gap-4 mt-6">
              {marketKeys.map((key) => (
                <div 
                  ...
                  className="bg-white/[0.03] border border-white/[0.06] h-24 rounded-[26px] flex flex-col justify-center px-6 cursor-pointer hover:bg-white/[0.06] hover:shadow-[0_0_20px_rgba(0,212,255,0.2)] transition-all"
                >
            ...
            <div className="bg-gradient-to-br from-[#00d4ff] to-[#0094ff] rounded-[35px] p-10 text-center text-[#0d121d] mt-6 shadow-xl">
              ...
              <div className="space-y-3">
                <a href="#" className="block bg-[#0d121d] text-white py-4 rounded-[20px] text-[11px] font-black uppercase">
                  Daily Access — $1
                </a>

                <a href="#" className="block border-2 border-[#0d121d] py-4 rounded-[20px] text-[11px] font-black uppercase">
                  Weekly Pro — $5
                </a>
              </div>

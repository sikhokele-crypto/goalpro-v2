...
// Revalidation time (checks for new data every 60 seconds)
...
async function getMatches() {
  try {
    ...
    console.error("Database error during build/render:", error);
    return [];
  }
}
      ...
      <main className="max-w-6xl mx-auto px-6 py-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-10">
          <div className="bg-slate-900 border border-slate-800 p-6 rounded-2xl">
            <div className="flex items-center justify-between mb-2">
              <span className="text-slate-400 font-bold text-sm uppercase tracking-wider">Total Matches</span>
        ...
        {matches.length === 0 ? (
          <div className="bg-slate-900/50 border-2 border-dashed border-slate-800 rounded-3xl p-20 text-center">
            ...
            <h3 className="text-xl font-bold text-slate-500 mb-2">Database is empty</h3>
            <p className="text-slate-600 mb-6">Connect your API and run the scraper to populate fixtures.</p>
            <a 
              href="/api/scrape" 
                ...
                >
                  ...
                  <div className="flex justify-between items-center mb-6">
                    ...
                    <div className="text-right">
                      ...
                      <div className="text-[10px] font-black uppercase text-slate-500">Confidence
